...
|:--------|:--------|:--------|
| Summary/title background color | `--theme-details-summary-background-color` | `$theme-accordion-button-background-color` |
| Panel background color |`--theme-details-background-color` | `$theme-accordion-background-color` |
| Component border color |  `--theme-details-border-color` | `$theme-accordion-border-color` |
| Component border width | `--theme-details-border-width` | `$theme-accordion-border-width` |
| Component font family | `--theme-details-font-family` | `$theme-accordion-font-family` |
