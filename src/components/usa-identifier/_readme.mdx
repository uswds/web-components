...
| `--usa-theme-identifier-primary-link-color`   | `--usa-system-color-gray-cool-10`      | Link color used in the disclaimer and USA.gov statement                                         |
| `--usa-theme-identifier-secondary-link-color` | `--usa-system-color-gray-cool-30`      | Link color used requi link list                                                                 |
